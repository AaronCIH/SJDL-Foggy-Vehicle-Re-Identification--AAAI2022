...
class SJDL(nn.Module):
    ...
    def __init__(self, model_name, num_classes_syn, num_classes_real, last_stride, model_reid_path="", model_rest_path="", fixed=False, mode="Train"):
...
def build_SJDL(cfg, num_classes_syn=100, num_classes_real=100, mode="Train"):
    ################################################################
    # input: foggy_imgs                                        
    ...
    ################################################################
    model = SJDL(cfg.MODEL.NAME, num_classes_syn, num_classes_real, cfg.MODEL.LAST_STRIDE, cfg.MODEL.PRETRAIN_PATH_reid, cfg.MODEL.PRETRAIN_PATH_res, cfg.MODEL.FIXED_REST, mode=mode)
