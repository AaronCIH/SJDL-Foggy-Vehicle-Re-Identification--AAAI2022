...
% Required data: clear_image_folder, depth_image_folder.  # Note: the depth folder needs to be created with the same name and put the corresponding depth map (i.e., predict_depth_gray.png) into it. <br>
